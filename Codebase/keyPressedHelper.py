        ...
        if event.key == "Left":
            ...
            if (
                ...
                for (x0, y0), (x1, y1) in app.listOfPaths:
                    if min(x0, x1) + 15 <= app.TA.playerX <= max(x0, x1) + 15 and min(
                        y0, y1
            ...
            if (
                ...
                if isOnAPath == False:
                    ...
                    if (
                        lowerX <= app.TA.playerX <= upperX
                        and lowerY <= app.TA.playerY <= upperY
                    ):
                        pass
                    else:
                        app.TA.movePlayer(-10, 0)
            ...
            if (
                ...
                for (x0, y0), (x1, y1) in app.listOfPaths:
                    if (
                        ...
                        and min(y0, y1) + 15 <= app.TA.playerY <= max(y0, y1) + 15
                    ):
                        isOnAPath = True
                        break
                if isOnAPath == False:
...
def checkTAReachedOHQStudent(app):
    ...
    if lowerX <= app.TA.playerX <= upperX and lowerY <= app.TA.playerY <= upperY:
